...
def run_command(base_path, inter_path):
    ...
    for _dir in dirs:
        if _dir not in ["test_output_files", "git_log_output_files"] and os.path.isdir(_dir): # ignore files and directories generated by our scripts
...
def parse_args():
    ...
    """
    parser = argparse.ArgumentParser(description="Flags students who took too long between GitHub Classroom assignment repository creation and final code push")
    ...
    parser.add_argument("-t", "--time_allowed", type=int, required=False,
